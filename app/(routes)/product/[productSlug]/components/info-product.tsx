...
const InfoProduct: React.FC<InfoProductProps> = ({ product }) => {
  ...
  const handleAddToLovedItems = useCallback(() => {
    addLoveItems(product);
  }, [addLoveItems, product]);
  return (
    <Card className="p-6 md:ml-8 rounded-lg shadow-black dark:shadow-white bg-slate-100 dark:bg-slate-900 w-full">
      {" "}
      ...
      <div className="flex gap-4 ms:gap-4 items-center">
        {" "}
        <p className="my-4 ms:text-2xl text-xl font-medium">
